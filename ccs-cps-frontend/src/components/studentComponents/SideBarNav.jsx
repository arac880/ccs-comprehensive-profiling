...
import { FaCalendarDays, FaCalendarCheck, FaBookOpen, FaClipboardCheck, FaBars, FaXmark, FaCircleUser } from "react-icons/fa6";
...
const NAV_ITEMS = [
  ...
  { name: "CollegeResearch", label: "College Research", Icon: FaBookOpen, path: "/student/research" },
];
      ...
      {NAV_ITEMS.map((item) => {
        ...
        return (
          <div
            ...
            onClick={() => go(item)}
          >
            <item.Icon className={`${styles.navIcon} ${isActive ? styles.navIconActive : ""}`} />
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <div
                ...
                title={item.label}
              >
                <item.Icon className={`${styles.collapsedNavIcon} ${isActive ? styles.collapsedNavIconActive : ""}`} />
  ...
  return (
    <div className={styles.sidebar}>
      <div className={styles.sidebarHeader}>
        ...
        <div className={styles.hamburgerBtn} onClick={() => setIsCollapsed(true)}>
          <FaBars className={styles.menuIcon} />
        </div>
      </div>
      <ProfileCard />
